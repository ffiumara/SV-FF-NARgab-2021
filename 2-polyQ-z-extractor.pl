...
#1) output file reporting all the pairwise combinations of gene/protein names in the input file 2 and the associated z coefficients, as derived from input file 1;
#2) output file reporting all the pairwise combinations of gene/protein names in the input file 3 and the associated z coefficients, as derived from input file 1;
#3) output file as output 1 without those pairs for which a z coefficient was not available (NA) in the input file 1;
#4) output file as output 2 without those pairs for which a z coefficient was not available (NA) in the input file 1;
